# Список программ использованных в работе.
  ...
  Для установки программ и внесения настроек в систему необходимо получить права
...
[## Настройка запуска приложений на дискретной видеокарте NVIDIA](97_start_apps_on_nvidia.md)


[## Настройка запуска приложений Flatpak на дискретной видеокарте NVIDIA](98_nvidia_in_flatpak.md)
